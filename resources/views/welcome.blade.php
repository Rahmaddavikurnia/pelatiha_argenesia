...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
     ...
     <!-- HERO -->
      ...
      <section class="py-0" id="home">
        <div class="bg-holder d-none d-sm-block" style="background-image:url(frontend/assets/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;">
        </div>
        <div class="bg-holder d-sm-none" style="background-image:url(frontend/assets/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;">
        </div>
        <div class="container">
      ...
      <!-- ABOUT -->
      <section class="py-5">
        <div class="bg-holder" style="background-image:url(frontend/assets/img/illustrations/bg.png);background-position:left top;background-size:initial;margin-top:-180px;">
        </div>   

        <div class="container">
          <div class="row flex-center">
            <div class="col-md-5 order-md-0 text-center text-md-start"><img class="img-fluid mb-4" src="frontend/assets/img/illustrations/passion.png" width="450" alt="" /></div>
      ...
      <section class="py-5 mt-5">
        <div class="bg-holder d-none d-sm-block" style="background-image:url(frontend/assets/img/illustrations/category-bg.png);background-position:right top;background-size:200px 320px;">
        </div>
        <!--/.bg-holder-->
              ...
              <div class="row">
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="frontend/assets/img/illustrations/finance.png" height="120" alt="" />
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="frontend/assets/img/illustrations/design.png" height="120" alt="" />
                      <div class="card-body px-2">
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="frontend/assets/img/illustrations/programmer.png" height="120" alt="" />
                      <div class="card-body px-2">
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="frontend/assets/img/illustrations/production.png" height="120" alt="" />
                      <div class="card-body px-2">
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="frontend/assets/img/illustrations/education.png" height="120" alt="" />
                      <div class="card-body px-2">
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="frontend/assets/img/illustrations/consultancy.png" height="120" alt="" />
                      <div class="card-body px-2">
      ...
      <!-- PENGAJAR -->
      <section id="teachers" class="py-0"><img class="w-100" src="frontend/assets/img/illustrations/come-on-join.png" alt="" />
        <div class="container">
                 ...
                 <!-- COROUSEL 1 -->
                  ...
                  <div class="carousel-item" data-bs-interval="2000">
                    <div class="row h-100 m-lg-7 mx-3 mt-6 mx-md-4 my-md-7">
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="frontend/assets/img/gallery/user-1.png" alt="" /></div>
                          <div class="card-body d-flex flex-column flex-center py-6">
                      ...
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="frontend/assets/img/gallery/user-2.png" alt="" /></div>
                          <div class="card-body d-flex flex-column flex-center py-6">
                      ...
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="frontend/assets/img/gallery/user-3.png" alt="" /></div>
                          <div class="card-body d-flex flex-column flex-center py-6">
     ...
     <!-- FOOTER -->
      <section class="py-0 bg-primary-gradient">
        <div class="bg-holder" style="background-image:url(frontend/assets/img/illustrations/footer-bg.png);background-position:center;background-size:cover;">
        </div>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="frontend/vendors/@popperjs/popper.min.js"></script>
    <script src="frontend/vendors/bootstrap/bootstrap.min.js"></script>
    <script src="frontend/vendors/is/is.min.js"></script>
